...
# Colocated DAPO with blockwise FP8 + persistent FP8 parameters for Qwen3.5-35B-A3B-Base (MoE).
# Hardware: 2 nodes of 8xH100
#
# bash examples/train/algorithms/dapo/prepare_dapo_data.sh
# bash examples/train/fp8/run_fp8_hopper_blockwise_fp8param_qwen35_35b_a3b.sh
#
...
#
# fp8_param is most effective on MoE models: the routed experts hold most of
# the parameters and all quantize, cutting per-GPU parameter storage by ~42%.
...
uv run --isolated --extra megatron -m examples.train.algorithms.dapo.main_dapo \
  ...
  trainer.run_name="fp8_hopper_blockwise_fp8param_qwen35_35b_a3b" \
